...
void TempRenderer::DrawImage(ImageStuff::BitmapImage* image, int64_t x, int64_t y, int64_t sx, int64_t sy)
{
    GlobalDrawImage(image, x, y, sx, sy, (Framebuffer*)framebuffer);
}