...
BASE_C_FLAGS = -mcmodel=large -std=c17 -ffreestanding -fshort-wchar -mno-red-zone -fno-omit-frame-pointer -fno-exceptions -ffunction-sections -fdata-sections
BASE_CPP_FLAGS = -mcmodel=large -ffreestanding -fshort-wchar -mno-red-zone -fno-omit-frame-pointer -fno-exceptions -fpermissive -Wno-pmf-conversions -ffunction-sections -fdata-sections
