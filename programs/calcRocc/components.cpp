...
void style(GuiInstance *guiInstance) {
  ...
  plusBtn->OnMouseClickedCallBack = OnButtonClicked;
  ...
  dashBtn->OnMouseClickedCallBack = OnButtonClicked;
  ...
  starBtn->OnMouseClickedCallBack = OnButtonClicked;
  ...
  slashBtn->OnMouseClickedCallBack = OnButtonClicked;
  ...
  dotBtn->OnMouseClickedCallBack = OnButtonClicked;
  ...
  zeroBtn->OnMouseClickedCallBack = OnButtonClicked;
  ...
  for (int i = 1; i <= 9; ++i) {
    ...
    tempBtn->OnMouseClickedCallBack = OnButtonClicked;
  }
